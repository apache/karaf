...
public class InstanceToTableMapper {
    ...
    private static CompositeDataSupport mapInstance(Instance instance, CompositeType comp)
    ...
    private static CompositeType createRowType() throws OpenDataException {
        ...
        String[] descriptions =
                new String[] {
                    "The Process ID of the instance or 0 if not running",
                    "The name of the instance",
                    "Whether the instance is root",
        ...
        CompositeType comp =
                new CompositeType(
                        "Instances", desc, InstancesMBean.INSTANCE, descriptions, itemTypes);
        return comp;
    }
