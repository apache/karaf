...
public class List extends BundlesCommand {
    ...
    @Option(
            name = "-l",
            aliases = {},
            description = "Show the locations",
            required = false,
            multiValued = false)
    ...
    @Option(
            name = "-s",
            description = "Shows the symbolic name",
            required = false,
            multiValued = false)
    ...
    @Option(
            name = "-u",
            description = "Shows the update locations",
            required = false,
            multiValued = false)
    boolean showUpdate;
    ...
    @Option(
            name = "-r",
            description = "Shows the bundle revisions",
            required = false,
            multiValued = false)
    ...
    protected Object doExecute(java.util.List<Bundle> bundles) throws Exception {
        ...
        boolean effectiveShowName =
                showName || (!showLocation && !showSymbolic && !showUpdate && !showRevisions);
        ...
        for (Bundle bundle : bundles) {
            ...
            if (info.getStartLevel() >= bundleLevelThreshold) {
                ...
                if (effectiveShowName) {
                    String bundleName =
                            (info.getName() == null) ? info.getSymbolicName() : info.getName();
