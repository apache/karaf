...
public abstract class DatatypeFactory {
    ...
    private static final String DATATYPEFACTORY_IMPLEMENTATION_CLASS =
    ...
    public static DatatypeFactory newDefaultInstance() {
        try {
            return $FactoryFinder.newInstance(
                    DatatypeFactory.class, DATATYPEFACTORY_IMPLEMENTATION_CLASS, null, false, true);
    ...
    public Duration newDurationDayTime(final String lexicalRepresentation) {
        if (lexicalRepresentation == null) {
            throw new NullPointerException(
                    "Trying to create an xdt:dayTimeDuration with an invalid lexical representation of \"null\"");
        }
