...
/**
 * Formats a {@link Date} in the format "yyyy-MM-dd HH:mm:ss,SSS" for example "1999-11-27
 * 15:49:37,459".
 *
 * <p>Refer to the <a href=http://www.cl.cam.ac.uk/~mgk25/iso-time.html>summary of the International
 * Standard Date and Time Notation</a> for more information on this format.
 *
 * @since 0.7.5
 */
public class ISO8601DateFormat extends AbsoluteTimeDateFormat {
    ...
    /**
     * Appends a date in the format "YYYY-mm-dd HH:mm:ss,SSS" to <code>sbuf</code>. For example:
