...
public class SetLogLevelTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        EasyMock.expect(configAdmin.getConfiguration(LogServiceImpl.CONFIGURATION_PID, null))
    ...
    public void testUnsetLogLevel() throws Exception {
        ...
        assertFalse(
                "Configuration for logger org.apache.karaf.test has been removed",
    ...
    public void testUnsetRootLogLevel() throws Exception {
        ...
        logMBean.setLevel("org.apache.karaf.test", "DEFAULT");
        assertEquals(
                "Configuration for root logger should not be removed",
                "INFO",
                properties.get(ROOT_LOGGER));
    }
}
