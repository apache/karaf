...
public class ManageRealmCommandTest {
    ...
    /**
     * Verify that JAAS manage command selects the correct realm, given some index.
     *
     * @param cmd the JAAS manage realm command.
     * @param index the index to verify.
     * @param realms the array of realms.
     * @throws Exception in case of verify failure.
     */
    private void doVerifyIndex(ManageRealmCommand cmd, int index, Config[] realms) throws Exception {
        ...
        // verify that the correct realms is returned -- cmd.index is 1-based
