...
@Command(
        scope = "jaas",
        name = "update",
        description = "Apply pending modification on the edited JAAS Realm")
@Service
public class UpdateCommand extends JaasCommandSupport {
    ...
    public Object execute() throws Exception {
        ...
        if (engine == null) {
            System.err.println(
                    "Can't update the JAAS realm (no backing engine service registered)");
            return null;
        }
    ...
    protected Object doExecute(BackingEngine engine) throws Exception {
        ...
        Queue<? extends JaasCommandSupport> commands =
                (Queue<? extends JaasCommandSupport>) session.get(JAAS_CMDS);
