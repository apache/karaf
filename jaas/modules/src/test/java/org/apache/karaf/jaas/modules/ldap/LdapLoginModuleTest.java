...
public class LdapLoginModuleTest extends AbstractLdapTestUnit {
    ...
    public void testNonAdminLogin() throws Exception {
        ...
        Subject subject = new Subject();
        module.initialize(
                subject, new NamePasswordCallbackHandler("cheese", "foodie"), null, options);
    ...
    public void testBadPassword() throws Exception {
        ...
        Subject subject = new Subject();
        module.initialize(
                subject, new NamePasswordCallbackHandler("admin", "blahblah"), null, options);
    ...
    public void testUserNotFound() throws Exception {
        ...
        Subject subject = new Subject();
        module.initialize(
                subject, new NamePasswordCallbackHandler("imnothere", "admin123"), null, options);
    ...
    public void testRoleMappingAdvanced() throws Exception {
        ...
        assertThat(
                ...
                containsInAnyOrder("karaf", "test", "another"));
