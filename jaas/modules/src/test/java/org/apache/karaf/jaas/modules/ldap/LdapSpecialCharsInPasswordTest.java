...
@CreateDS(
        name = "LdapSpecialCharsInPasswordTest-class",
...
public class LdapSpecialCharsInPasswordTest extends LdapLoginModuleTest {
    ...
    public void updatePort() throws Exception {
        ldapProps(
                "org/apache/karaf/jaas/modules/ldap/ldap_special_char_in_password.properties",
    ...
    protected Properties ldapLoginModuleOptions() throws IOException {
        ...
        File file =
                new File(
                        basedir
                                + "/target/test-classes/org/apache/karaf/jaas/modules/ldap/ldap_special_char_in_password.properties");
    ...
    public void changeAdminPassword() throws Exception {
        LdapConnection connection =
                new LdapNetworkConnection("localhost", getLdapServer().getPort());
