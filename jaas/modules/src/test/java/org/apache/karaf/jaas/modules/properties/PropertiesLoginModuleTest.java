...
public class PropertiesLoginModuleTest {
    ...
    public void testBasicLogin() throws Exception {
        ...
        try {
            ...
            module.initialize(
                    subject, new NamePasswordCallbackHandler("abc", "xyz"), null, options);
            ...
            assertThat(
                    names(subject.getPrincipals(UserPrincipal.class)), containsInAnyOrder("abc"));
            assertThat(
                    names(subject.getPrincipals(RolePrincipal.class)),
                    containsInAnyOrder("myrole"));
    ...
    public void testLoginIncorrectPassword() throws Exception {
        ...
        try {
            ...
            options.put(PropertiesLoginModule.USER_FILE, f.getAbsolutePath());
            module.initialize(
                    new Subject(), new NamePasswordCallbackHandler("abc", "abc"), null, options);
            try {
                module.login();
    ...
    public void testLoginWithGroups() throws Exception {
        ...
        try {
            ...
            Subject subject = new Subject();
            module.initialize(
                    subject, new NamePasswordCallbackHandler("pqr", "abc"), null, options);
            ...
            assertThat(
                    names(subject.getPrincipals(UserPrincipal.class)), containsInAnyOrder("pqr"));
            assertThat(
                    names(subject.getPrincipals(GroupPrincipal.class)),
                    containsInAnyOrder("group1"));
    ...
    private void testCannotLoginAsGroupDirectly(final String name)
        ...
        try {
            ...
            options.put(PropertiesLoginModule.USER_FILE, f.getAbsolutePath());
            module.initialize(
                    new Subject(), new NamePasswordCallbackHandler(name, "group"), null, options);
            try {
                module.login();
                Assert.fail(
                        "The login should have failed as you cannot log in under a group name directly");
            } catch (FailedLoginException fle) {
                // good
            }
        } finally {
    ...
    @Test
    public void testNonExistantPropertiesFile()
    ...
    private String getTestUsersFile() {
        return this.getClass()
                .getClassLoader()
                .getResource("org/apache/karaf/jaas/modules/properties/test.properties")
                .getFile();
    }
}
