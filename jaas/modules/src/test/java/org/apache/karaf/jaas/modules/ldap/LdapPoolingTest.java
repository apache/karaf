...
public class LdapPoolingTest extends AbstractLdapTestUnit {
    ...
    public void testSSLConnectionPool() throws Exception {
        ...
        env.put("java.naming.ldap.factory.socket", LDAPLoginModule.ManagedSSLSocketFactory.class.getName());
        ...
        LDAPLoginModule.ManagedSSLSocketFactory.setSocketFactory(new LDAPLoginModule.ManagedSSLSocketFactory(sslContext.getSocketFactory()) {
            @Override
        ...
        context.close();
        LDAPLoginModule.ManagedSSLSocketFactory.setSocketFactory(null);
