...
public class KarafRealm implements JaasRealm {
    ...
    private static final String FILE_AUDIT_MODULE =
            "org.apache.karaf.jaas.modules.audit.FileAuditLoginModule";
    private static final String LOG_AUDIT_MODULE =
            "org.apache.karaf.jaas.modules.audit.LogAuditLoginModule";
    private static final String EVENTADMIN_AUDIT_MODULE =
    ...
    public AppConfigurationEntry[] getEntries() {
        ...
        propertiesOptions.put(
                "detailed.login.exception", properties.get("detailed.login.exception"));
