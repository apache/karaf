...
public abstract class AbstractKarafLoginModule implements LoginModule {
    ...
    public void initialize(Subject sub, CallbackHandler handler, Map<String, ?> options) {
        ...
        this.detailedLoginExcepion =
                Boolean.parseBoolean((String) options.get("detailed.login.exception"));
                ...
                encryptionSupport.getEncryption() != null
                        ? encryptionSupport
                                ...
                                .checkPassword(
                                        ...
                                        encrypted.substring(
                                                prefix.length(),
                                                encrypted.length() - suffix.length()))
                        : false;
        return encrypted.equals(newEncrypted) || isMatch;
    }
}
