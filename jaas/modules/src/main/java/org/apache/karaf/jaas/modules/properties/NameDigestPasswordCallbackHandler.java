...
public class NameDigestPasswordCallbackHandler implements CallbackHandler {
    ...
    private static final Logger LOG =
            LoggerFactory.getLogger(NameDigestPasswordCallbackHandler.class);
    ...
    public NameDigestPasswordCallbackHandler(
            String username, String password, String nonce, String createdTime) {
    ...
    private boolean invokePasswordCallback(Callback callback) {
        String cbname =
                passwordCallbackName == null ? PASSWORD_CALLBACK_NAME : passwordCallbackName;
