...
public interface Group extends Principal {
     ...
     * @return true if the member was successfully added, false if the principal was already a
     *     member.
     */
    ...
    /**
     * Returns an enumeration of the members in the group. The returned objects can be instances of
     * either Principal or Group (which is a subclass of Principal).
     *
