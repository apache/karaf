...
public class SubsystemTest {
    ...
    public void test1() throws Exception {
        RepositoryImpl repo =
                new RepositoryImpl(getClass().getResource("data1/features.xml").toURI());
        ...
        SubsystemResolver resolver =
                new SubsystemResolver(this.resolver, new TestDownloadManager(getClass(), "data1"));
        resolver.prepare(partitionByName(repo.getFeatures()), features, Collections.emptyMap());
    ...
    public void test2() throws Exception {
        ...
        RepositoryImpl repo =
                new RepositoryImpl(getClass().getResource("data2/features.xml").toURI());
        ...
        SubsystemResolver resolver =
                new SubsystemResolver(this.resolver, new TestDownloadManager(getClass(), "data2"));
        resolver.prepare(partitionByName(repo.getFeatures()), features, Collections.emptyMap());
        resolver.resolve(FeaturesService.DEFAULT_FEATURE_RESOLUTION_RANGE, null, null, null);
    ...
    public void testOverridesCompatibilityModeSymbolicNameMatches() throws Exception {
        RepositoryImpl repo =
                new RepositoryImpl(getClass().getResource("data3/features.xml").toURI());

        // this is normally done by features processor
        ((Bundle) repo.getFeatures()[0].getBundles().get(0))
                .setOverriden(BundleInfo.BundleOverrideMode.OSGI);
        ...
        SubsystemResolver resolver =
                new SubsystemResolver(this.resolver, new TestDownloadManager(getClass(), "data3"));
        resolver.prepare(partitionByName(repo.getFeatures()), features, Collections.emptyMap());
        resolver.resolve(FeaturesService.DEFAULT_FEATURE_RESOLUTION_RANGE, null, null, null);
    ...
    public void testOverridesMavenMode() throws Exception {
        ...
        // this is normally done by features processor
        ((Bundle) repo.getFeatures()[0].getBundles().get(0))
                .setOverriden(BundleInfo.BundleOverrideMode.MAVEN);
        ((Bundle) repo.getFeatures()[0].getBundles().get(0)).setOriginalLocation("a");
        ((Bundle) repo.getFeatures()[0].getBundles().get(0)).setLocation("c");
        ...
        // we expect override to be used - symbolic name between a and c doesn't match, but we don't
        // care
        Map<String, Set<String>> expected = new HashMap<>();
    ...
    public void testConditionalUnsatisfiedWithOptional() throws Exception {
        RepositoryImpl repo =
                new RepositoryImpl(getClass().getResource("data4/features.xml").toURI());
        ...
        SubsystemResolver resolver =
                new SubsystemResolver(this.resolver, new TestDownloadManager(getClass(), "data4"));
        resolver.prepare(partitionByName(repo.getFeatures()), features, Collections.emptyMap());
        resolver.resolve(FeaturesService.DEFAULT_FEATURE_RESOLUTION_RANGE, null, null, null);
    ...
    public void testFeatureOptional() throws Exception {
        RepositoryImpl repo =
                new RepositoryImpl(getClass().getResource("data5/features.xml").toURI());
        ...
        SubsystemResolver resolver =
                new SubsystemResolver(this.resolver, new TestDownloadManager(getClass(), "data5"));
        resolver.prepare(partitionByName(repo.getFeatures()), features, Collections.emptyMap());
        resolver.resolve(FeaturesService.DEFAULT_FEATURE_RESOLUTION_RANGE, null, null, null);
    ...
    public void testFeatureOptionalAlreadyProvided2() throws Exception {
        RepositoryImpl repo =
                new RepositoryImpl(getClass().getResource("data6/features.xml").toURI());
        ...
        SubsystemResolver resolver =
                new SubsystemResolver(this.resolver, new TestDownloadManager(getClass(), "data6"));
        resolver.prepare(partitionByName(repo.getFeatures()), features, Collections.emptyMap());
        resolver.resolve(FeaturesService.DEFAULT_FEATURE_RESOLUTION_RANGE, null, null, null);
    ...
    public void testResourceRepositories() throws Exception {
        RepositoryImpl repo =
                new RepositoryImpl(getClass().getResource("data7/features.xml").toURI());
        ...
        SubsystemResolver resolver =
                new SubsystemResolver(this.resolver, new TestDownloadManager(getClass(), "data7"));
        resolver.prepare(partitionByName(repo.getFeatures()), features, Collections.emptyMap());
        resolver.resolve(FeaturesService.DEFAULT_FEATURE_RESOLUTION_RANGE, null, null, null);
    ...
    public void testMultipleVersionsForFeatureDependency() throws Exception {
        RepositoryImpl repo1 =
                new RepositoryImpl(getClass().getResource("data9/pax-web-6.0.3.xml").toURI());
        RepositoryImpl repo2 =
                new RepositoryImpl(getClass().getResource("data9/pax-web-6.0.4.xml").toURI());
        ...
        SubsystemResolver resolver =
                new SubsystemResolver(this.resolver, new TestDownloadManager(getClass(), "data9"));
        resolver.prepare(ds.featuresByName(), features, Collections.emptyMap());
        resolver.resolve(FeaturesService.DEFAULT_FEATURE_RESOLUTION_RANGE, null, null, null);
    ...
    public void testBlacklistedBundles() throws Exception {
        RepositoryImpl repo =
                new RepositoryImpl(getClass().getResource("data10/features.xml").toURI());
        ...
        SubsystemResolver resolver =
                new SubsystemResolver(this.resolver, new TestDownloadManager(getClass(), "data10"));
        resolver.prepare(partitionByName(repo.getFeatures()), features, Collections.emptyMap());
        resolver.resolve(FeaturesService.DEFAULT_FEATURE_RESOLUTION_RANGE, null, null, null);
