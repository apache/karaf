...
public class DefaultFuture<T extends DefaultFuture<?>> {
    ...
    /**
     * Wait for the Future to be ready. If the requested delay is 0 or negative, this method
     * immediately returns the value of the 'ready' flag. Every 5 second, the wait will be suspended
