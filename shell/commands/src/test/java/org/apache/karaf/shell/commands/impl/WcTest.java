...
public class WcTest extends TestCase {
    ...
    public void testOneFile() throws Exception {
        ...
        String report = wcAction.getFilesWordCountReport(files);
    ...
    public void testThreeFiles() throws Exception {
        ...
        assertEquals("A single file report should not contain a total", "\t11\t12\t34\tWcActionTestSmall.txt\n" +
                "\t34\t487\t3307\tWcActionTestLarge.txt\n" +
                "\t11\t12\t34\tWcActionTestSmall.txt\n" +
                "\t56\t511\t3375\ttotal", report);
    }
    ...
    public WcAction.WordCounts getWordCounts(InputStream stream) throws Exception {
        WcAction wcAction = new WcAction();
        WcAction.WordCounts wordCounts = wcAction.getWordCounts(stream);
