 ...
 * This annotation can be applied to attributes of a class implementing an Action. The value of the
 * command line option will be automatically converted to the attribute type.
 *
 ...
 *     <p>This will be represented as --force on the command line.
 *     <h2>Example 2 (mandatory String option):</h2>
 *     <code>@Option(name="-name",required=true) String name;</code>
 *     <p>This will be represented as -name=&lt;myname&gt; on the command line and the command will
 *     be rejected if the option is not given.
 */
...
public @interface Option {
    ...
    /**
     * Specify a list of aliases for this option. Useful when using an option with short or long
     * names.
     *
    ...
    /**
     * The last argument can be multi-valued in which case the field type must be a List. On the
     * command line, multi-valued options are used with specifying the option multiple times with
     * different values.
     *
