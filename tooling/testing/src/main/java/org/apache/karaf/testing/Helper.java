...
public final class Helper {
    ...
    public static FeaturesScannerProvisionOption loadKarafStandardFeatures(String... features) {
        return scanFeatures(
            maven().groupId("org.apache.karaf.assemblies.features").artifactId("org.apache.karaf.feature.standard").type("xml")
    ...
    public static FeaturesScannerProvisionOption loadKarafEnterpriseFeatures(String... features) {
        return scanFeatures(
            maven().groupId("org.apache.karaf.assemblies.features").artifactId("org.apache.karaf.feature.enterprise").type("xml")
                .classifier("features").versionAsInProject(), features);
    }
