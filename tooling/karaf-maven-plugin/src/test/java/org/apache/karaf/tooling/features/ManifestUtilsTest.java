...
public class ManifestUtilsTest extends TestCase {
    ...
    public void testMatches() {
        ...
        assertFalse(
                matches(
                        clause("org.apache.karaf.test", "1.2.0"),
                        clause("org.apache.karaf.test", "[1.1.0, 1.1.0]")));
        assertTrue(
                matches(
                        clause("org.apache.karaf.test", "1.1.0"),
                        clause("org.apache.karaf.test", "[1.1.0, 1.1.0]")));

        // a single version means >= 1.0.0, so 1.1.O should be a match
        assertTrue(
                matches(
                        clause("org.apache.karaf.test", "1.0.0"),
                        clause("org.apache.karaf.test", "1.1.0")));
        assertTrue(
                matches(clause("org.apache.karaf.test", "1.0.0"), clause("org.apache.karaf.test")));

        assertFalse(
                matches(
                        clause("org.apache.karaf.test", "[1.1.0, 1.2.0)"),
                        clause("org.apache.karaf.test", "[1.0.0, 1.0.0]")));
        assertFalse(
                matches(
                        clause("org.apache.karaf.test", "[1.1.0, 1.2.0)"),
                        clause("org.apache.karaf.test", "[1.2.0, 1.2.0]")));
        assertTrue(
                matches(
                        clause("org.apache.karaf.test", "[1.1.0, 1.2.0)"),
                        clause("org.apache.karaf.test", "[1.1.0, 1.1.0]")));
        assertTrue(
                matches(
                        clause("org.apache.karaf.test", "[1.1.0, 1.2.0)"),
                        clause("org.apache.karaf.test", "[1.1.1, 1.1.1]")));
        assertTrue(
                matches(
                        clause("org.apache.karaf.test", "[1.1.0, 1.1.0]"),
                        clause("org.apache.karaf.test", "[1.1.0, 1.1.0]")));
        assertFalse(
                matches(
                        clause("org.apache.karaf.test", "[1.1.0, 1.1.0]"),
                        clause("org.apache.karaf.test", "1.1.1")));
        assertTrue(
                matches(
                        clause("org.apache.karaf.test", "[1.1.0, 1.1.0]"),
                        clause("org.apache.karaf.test", "1.0.0")));
