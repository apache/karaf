...
public class ManifestUtils {
    ...
    /**
     * Get the list of imports from the manifest. If no imports have been defined, this method
    ...
    /**
     * Get the list of exports from the manifest. If no exports have been defined, this method
     * returns an empty list.
     *
     * @param manifest the manifest
