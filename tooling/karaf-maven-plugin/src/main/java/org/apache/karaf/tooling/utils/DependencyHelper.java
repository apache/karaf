...
/**
 * An interface for accessing available Aether subsystem (Sonatype for Maven 3.0.x or Eclipse for
 * Maven 3.1.x)
 *
 * <p>Some methods have {@link Object} parameters because they should be able to receive Aether
 * classes from both Aether variants.
 */
public interface DependencyHelper {
    ...
    void getDependencies(MavenProject project, boolean useTransitiveDependencies)
     ...
     * @return The corresponding PAX URL mvn format
     ...
     *
     * @param name The Aether coordinate format
