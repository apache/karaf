...
/**
 * A very simplistic LRU cache based on LinkedHashMap. It grows up to the size specified in the
 * constructor, evicting least recently accessed entries to keep the size there.
 */
