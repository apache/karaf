...
public class AddToRepositoryMojo extends AbstractFeatureMojo {
    ...
    /**
     * If set to true the exported bundles will be directly copied into the repository dir. If set
     * to false the default maven repository layout will be used
     */
    @Parameter private boolean flatRepoLayout;
    ...
    private void copyBundlesConditionalToDestRepository(
            List<? extends BundleInfo> artifactRefsConditional) throws MojoExecutionException {
    ...
    private void copyBundlesToDestRepository(List<? extends Bundle> artifactRefs)
    ...
    private void copyConfigFilesToDestRepository(List<? extends ConfigFile> artifactRefs)
            throws MojoExecutionException {
    ...
    /**
     * Get relative path for artifact TODO consider DefaultRepositoryLayout
     *
     * @param artifact
