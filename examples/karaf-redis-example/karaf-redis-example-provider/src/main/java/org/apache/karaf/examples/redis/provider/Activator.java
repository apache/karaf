...
public class Activator extends BaseActivator {
    ...
    protected void doStart() throws Exception {
        ...
        register(UserService.class, userServiceImpl);
        UserServiceRedisImpl userServiceRedisImpl = new UserServiceRedisImpl();
        register(UserServiceRedis.class, userServiceRedisImpl);
    }
}
