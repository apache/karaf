...
public class ACLConfigurationParserTest {
    ...
    public void testParseRoles() {
        assertEquals(
                Arrays.asList("some_role"), ACLConfigurationParser.parseRoles(" some_role   "));
    ...
    public void testGetRolesForInvocation() {
        ...
        assertEquals(
                ...
                ACLConfigurationParser.getRolesForInvocation(
                        "foo", new Object[] {}, new String[] {}, config, roles1));
        ...
        assertEquals(
                Specificity.NO_MATCH,
                ACLConfigurationParser.getRolesForInvocation(
                        "test", new Object[] {}, new String[] {}, config, roles3));
        assertEquals(0, roles3.size());

        List<String> roles4 = new ArrayList<>();
        assertEquals(
                Specificity.ARGUMENT_MATCH,
                ACLConfigurationParser.getRolesForInvocation(
                        "bar",
                        new Object[] {"aa", 42},
        ...
        assertEquals(
                Specificity.NAME_MATCH,
                ACLConfigurationParser.getRolesForInvocation(
                        "bar", new Object[] {42}, new String[] {"int"}, config, roles9));
        assertEquals(Arrays.asList("rf"), roles9);

        List<String> roles10 = new ArrayList<>();
        assertEquals(
                Specificity.WILDCARD_MATCH,
                ACLConfigurationParser.getRolesForInvocation(
                        "barr", new Object[] {42}, new String[] {"int"}, config, roles10));
