...
public class JMXSecurityTest extends KarafTestSupport {
        ...
        options.addAll(
                Arrays.asList(
                        editConfigurationFilePut(
                                "etc/jmx.acl.org.apache.karaf.service.cfg",
                                "getServices()",
                                "admin"),
                        editConfigurationFilePut(
                                "etc/jmx.acl.org.apache.karaf.service.cfg",
    ...
    public void testJMXSecurityAsViewer() throws Exception {
        ...
        org.osgi.service.cm.Configuration configuration =
                configurationAdmin.getConfiguration("org.apache.karaf.management", null);
        ...
        assertEquals(
                "Changing the start level should have no effect for a viewer",
                100,
                connection.getAttribute(systemMBean, "StartLevel"));
        ...
        assertEquals(
                "Changing the verbosity should have no effect for a viewer",
                false,
                connection.getAttribute(memoryMBean, "Verbose"));
    ...
    public void testJMXSecurityAsAdmin() throws Exception {
        ...
        try {
            ...
            assertGetAttributeRetry(
                    "Start level should have been changed",
                    101,
                    connection,
                    systemMBean,
                    "StartLevel");
        ...
        assertGetAttributeRetry(
                "Start level should be changed back now",
                100,
                connection,
                systemMBean,
                "StartLevel");
        ...
        assertEquals(
                "Verbosity should be changed back to false",
                false,
                connection.getAttribute(memoryMBean, "Verbose"));
        connection.invoke(memoryMBean, "gc", new Object[] {}, new String[] {});
    ...
    private void testJMXSecurityMBean(
            MBeanServerConnection connection, boolean isManager, boolean isAdmin)
            throws MalformedObjectNameException, InstanceNotFoundException, MBeanException,
                    ReflectionException, IOException {
        ObjectName securityMBean =
                new ObjectName("org.apache.karaf:type=security,area=jmx,name=root");
        ...
        CompositeData cd3 =
                td2.get(new Object[] {serviceMBean.toString(), "getServices(long,boolean)"});
    ...
    private void testKarafConfigAdminMBean(
            MBeanServerConnection connection, boolean isManager, boolean isAdmin)
    ...
    private void testKarafConfigAdminMBean(
            MBeanServerConnection connection, String pidPrefix, boolean shouldSucceed)
            throws MalformedObjectNameException, InstanceNotFoundException, MBeanException,
        ...
        Map<?, ?> m1 =
                (Map<?, ?>)
                        connection.invoke(
                                ...
                                new Object[] {pid},
                                new String[] {String.class.getName()});
        if (shouldSucceed) assertEquals("y", m1.get("x"));
        else assertNull(m1.get("x"));
        assertJmxInvoke(
                shouldSucceed,
                connection,
                mbean,
        ...
        Map<?, ?> m2 =
                (Map<?, ?>)
                        connection.invoke(
                                ...
                                new Object[] {pid},
                                new String[] {String.class.getName()});
        if (shouldSucceed) assertEquals("yz", m2.get("x"));
        else assertNull(m2.get("x"));
    ...
    private void testOSGiConfigAdminMBean(
            MBeanServerConnection connection, boolean isManager, boolean isAdmin) throws Exception {
        boolean found = false;

        // Find the OSGi Config Admin MBean(s) based on the Object Name pattern
        for (ObjectName name :
                connection.queryNames(new ObjectName("osgi.compendium:service=cm,*"), null)) {
            found = true;
            ...
            testOSGiConfigAdminMBean(
                    connection, name, "org.apache.karaf.command.acl", isAdmin, isAdmin);
            testOSGiConfigAdminMBean(
                    connection, name, "org.apache.karaf.service.acl", isAdmin, isAdmin);
            testOSGiConfigAdminMBean(
                    connection, name, "org.apache.karaf.somethingelse", isManager, isAdmin);
        }
    ...
    private void testOSGiConfigAdminMBean(
        ...
        assertJmxInvoke(
                ...
                mbean,
                "updateForLocation",
                new Object[] {pid2, location2, tds2},
                new String[] {
                    String.class.getName(), String.class.getName(), TabularData.class.getName()
                });
        TabularData td2 =
                (TabularData)
                        connection.invoke(
            ...
            String[][] configs2 =
                    (String[][])
                            connection.invoke(
                                    mbean,
                                    "getConfigurations",
                                    new Object[] {"(service.pid=" + pidPrefix + infix + "*)"},
                                    new String[] {String.class.getName()});
    ...
    private void assertGetAttributeRetry(
            String explanation,
            Object expected,
            MBeanServerConnection connection,
            ObjectName mbean,
    ...
    private Object assertJmxInvoke(
    ...
    private void assertSetAttributeSecEx(
            MBeanServerConnection connection, ObjectName mbeanObjectName, Attribute attribute)
    ...
    private void assertInvokeSecEx(
            MBeanServerConnection connection, ObjectName mbeanObjectName, String method)
            throws InstanceNotFoundException, MBeanException, ReflectionException, IOException {
        try {
