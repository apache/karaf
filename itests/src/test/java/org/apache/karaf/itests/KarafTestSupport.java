...
public class KarafTestSupport {
    ...
    */
    ...
    public JMXConnector getJMXConnector() throws Exception {
        ...
        File managementCfgFile = new File(karafBase + "/etc", "org.apache.karaf.management.cfg");
        ...
        if (managementCfgFile.exists()) {
            ...
            if (properties.containsKey("rmiServerPort")) {
                rmiServerAddress = "localhost:" + properties.getProperty("rmiServerPort");
            }
            if (properties.containsKey("rmiRegistryPort")) {
                rmiRegistryAddress = "localhost:" + properties.getProperty("rmiRegistryPort");
            }
