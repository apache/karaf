...
public class PackagesMBeanImpl extends StandardMBean implements PackagesMBean {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(PackagesMBeanImpl.class);
    ...
    public TabularData getImports() {
        try {
            String[] names =
                    new String[] {
                        "PackageName", "Filter", "Optional", "ID", "Bundle Name", "Resolvable"
                    };
            CompositeType bundleType =
                    new CompositeType(
                            "PackageImports",
            ...
            for (PackageRequirement req : imports) {
                ...
                try {
                    ...
                    throw new RuntimeException(
                            "Id: " + req.getBundle().getBundleId() + ", filter: " + req.getFilter(),
                            e);
                }
            }
            return table;
