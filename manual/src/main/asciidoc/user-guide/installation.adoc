...
[NOTE]
====
When/if the https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=881297[Debian Request For Package (RFP) of karaf] results in an official karaf package becoming available, the unofficial debian package will be discontinued.
====
