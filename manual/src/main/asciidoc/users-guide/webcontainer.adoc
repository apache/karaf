...
* http://wiki.eclipse.org/Jetty/Howto/Configure_Jetty[Standard configuration]
* http://wiki.eclipse.org/Jetty/Howto/Configure_SSL[Enable SSL]
* http://wiki.eclipse.org/Jetty/Reference/jetty.xml_syntax[Reference]
