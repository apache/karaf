...
TIP: If you want to turn Apache Karaf as a simple Maven repository, you can use http://karaf.apache.org/index/subprojects/cave.html[Apache Karaf Cave].
...
You can find details on the link:monitoring[] of the user guide.