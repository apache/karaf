...
public class StatementsTest {
    ...
    private static final String DEFAULT_CREATE_TABLE_STMT =
            "CREATE TABLE KARAF_LOCK (MOMENT BIGINT, NODE VARCHAR(20))";
    private static final String DEFAULT_POPULATE_TABLE_STMT =
            "INSERT INTO KARAF_LOCK (MOMENT, NODE) VALUES (1, 'karaf')";
    ...
    public void getDefaultLockCreateSchemaStatements() {
        assertArrayEquals(
                new String[] {DEFAULT_CREATE_TABLE_STMT, DEFAULT_POPULATE_TABLE_STMT},
    ...
    public void getCustomLockCreateSchemaStatements() {
        customizeStatements();
        String[] expectedCreateSchemaStmts =
                new String[] {
    ...
    public void getCustomLockCreateStatement() {
        ...
        assertEquals(
                "SELECT * FROM test.LOCK_TABLE FOR UPDATE", statements.getLockCreateStatement());
    }
