...
/**
 * Downloads a maven artifact and installs it into the given system directory. The layout follows
 * the conventions of a maven local repository.
 */
public class ArtifactInstaller {
    ...
    /**
     * Installs a {@link BundleInfo} into <code>system/</code> directory taking into account
     * <em>blacklisted</em> and <em>overriden</em> flags.
     *
     * @param bundle
     * @throws Exception
     */
    public void installArtifact(BundleInfo bundle) throws Exception {
        ...
        if (bundle.isOverriden() != BundleInfo.BundleOverrideMode.NONE) {
            LOGGER.info(
                    "      adding overriden maven artifact: "
                            + bundle.getLocation()
                            + " (original location: "
                            + bundle.getOriginalLocation()
                            + ")");
        } else {
    ...
    /**
     * Installs generic artifact to <code>system/</code> directory. For bundles, dedicated {@link
     * #installArtifact(BundleInfo)} should be used.
     *
     * @param location
     * @throws Exception
     */
