 ...
 *
 * <p>Red Hat licenses this file to you under the Apache License, version 2.0 (the "License"); you
...
@Command(
        name = "change-parents",
        scope = "profile",
        description = "Replace the profile's parents with the specified list of parents")
@Service
public class ProfileChangeParents implements Action {
    ...
    @Argument(
            index = 1,
            name = "parents",
            description = "The list of new parent profiles.",
            required = true,
            multiValued = true)
    @Completion(ProfileCompleter.class)
    ...
    public Object execute() throws Exception {
        ...
        Profile newProfile =
                ProfileBuilder.Factory.createFrom(profile).addParents(parentIds).getProfile();
